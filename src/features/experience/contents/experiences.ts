...
export const EXPERIENCE: ExperienceItem[] = [
  {
    ...
    description: `
대학·기관 CMS 운영 서비스를 담당하며, 사용자가 실제로 겪는 접근성과 운영의 마찰을 줄입니다.

- 지도 영역의 키보드 탐색 흐름을 점검하고 TreeWalker 기반 포커스 이동을 구현해 웹 접근성 심사 대응
- 반복되는 CMS 운영 이슈를 분석하고, 운영자가 바로 처리할 수 있는 화면과 흐름을 개선`,
  },
  {
    id: 1,
    type: "open-source",
