...
<ProjectDetail>
  <ProjectDetail.Header>Gemini 응답 지연 시각화</ProjectDetail.Header>
  <ProjectDetail.Body>
...
emitter.emit('ai-stream-done', { fullText });`}
    ...
    <ProjectDetail.Result isHighlighted>
      AI 응답 대기 체감 시간을 단축하고 대화의 실시간성 확보
...
<ProjectDetail>
  <ProjectDetail.Header>WebSocket 연결 시 쿠키 기반 인증 핸드셰이크</ProjectDetail.Header>
  <ProjectDetail.Body>
    <ProjectDetail.Section title="문제 상황" dotColor="bg-red-400">
...
<ProjectDetail>
  <ProjectDetail.Header link="/blog/7ea1b76d-2dbe-44e4-b3b1-719d6b46e64b">React Suspense 런타임 에러 방지를 위한 커스텀 ESLint 플러그인 개발</ProjectDetail.Header>
  <ProjectDetail.Body>
    <ProjectDetail.Section title="문제 상황" dotColor="bg-red-400">
