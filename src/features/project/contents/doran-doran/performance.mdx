...
<ProjectDetail>
  <ProjectDetail.Header>Monorepo 구조 도입을 통한 개발 효율성 증대</ProjectDetail.Header>
  <ProjectDetail.Body>
    ...
    <ProjectDetail.Section title="해결 방안" dotColor="bg-blue-400">
...
<ProjectDetail>
  <ProjectDetail.Header>Redis 캐싱을 통한 채팅 내역 조회 성능 3.7배 향상</ProjectDetail.Header>
  <ProjectDetail.Body>
...
return history;
    ...
    <ProjectDetail.Section title="성과 지표" dotColor="bg-green-400">
