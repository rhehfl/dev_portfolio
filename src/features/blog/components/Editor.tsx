    ...
    <div className="flex flex-col h-screen w-full bg-background text-foreground">
      ...
      <footer className="h-16 px-8 flex items-center justify-between shadow-[0_-1px_10px_rgba(15,23,42,0.1)] bg-card">
        ...
        <button
          ...
          aria-label={isSubmitting ? '출간 중입니다. 잠시 기다려 주세요.' : '글 출간하기'}
          className="bg-primary text-primary-foreground px-5 py-2 rounded font-bold transition hover:brightness-110 disabled:opacity-50 disabled:cursor-not-allowed focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
        >
